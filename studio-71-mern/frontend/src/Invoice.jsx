...
export default function Invoice() {
    ...
    useEffect(() => {
        // Updated to fetch the invoice data from your LIVE Render backend URL
    ...
    return (
        <div className="bg-gray-100 p-10 min-h-screen text-black font-sans">
            ...
            <div className="relative max-w-4xl mx-auto bg-white p-16 shadow-2xl min-h-[1100px] overflow-hidden">
                <div className="absolute top-[20%] left-[10%] w-[80%] opacity-5 -z-10 -rotate-12 text-9xl pointer-events-none">🧊</div>

                <div className="flex justify-between items-start border-b-2 border-blue-500 pb-4 mb-10">
                    <h1 className="text-5xl font-light text-blue-900 tracking-[0.2em]">INVOICE</h1>
                </div>
                ...
                <div className="mb-12 flex justify-between bg-gray-50 p-6 rounded-lg border border-gray-100">
                    <div>
